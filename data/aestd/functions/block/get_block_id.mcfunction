...
execute if block ~ ~ ~ #aestd.private:block_id_tree/quarter_1 run function aestd.private:block_id/get/1
execute if block ~ ~ ~ #aestd.private:block_id_tree/quarter_2 run function aestd.private:block_id/get/2
execute if block ~ ~ ~ #aestd.private:block_id_tree/quarter_3 run function aestd.private:block_id/get/3
execute if block ~ ~ ~ #aestd.private:block_id_tree/quarter_4 run function aestd.private:block_id/get/4
