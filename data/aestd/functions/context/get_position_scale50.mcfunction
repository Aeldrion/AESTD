...
execute as @e[type=minecraft:area_effect_cloud,tag=aestd.context.position_cloud,limit=1] run function aestd.internal:get_context_position_scale50_as_cloud
