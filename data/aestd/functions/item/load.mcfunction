...
# Input: storage aestd:data Item tag
...
execute if entity @s[type=minecraft:player, tag=!aestd.item.container] run function aestd.internal:inventory/load_player_item
execute if entity @s[type=minecraft:item, tag=!aestd.item.container] run function aestd.internal:inventory/load_dropped_item
execute if entity @s[type=#aestd:mobs, tag=!aestd.item.container] run function aestd.internal:inventory/load_mob_item
execute if entity @s[tag=aestd.item.container] run function aestd.internal:inventory/load_container_item
