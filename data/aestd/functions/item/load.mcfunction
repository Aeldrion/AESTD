...
# Input: save chunk (1519204 6 0 RecordItem.tag.aestd.SavedItem)|aestd.item.slot
...
## If the executing is a player, its aestd.item.slot score determines in what slot the item will be loaded
# See https://d1u5p3l4wpay3k.cloudfront.net/minecraft_gamepedia/b/b2/Items_slot_number.png?version=ef44f4a9d557e1d793780c5674ac76ec
# -1 mainhand
# -2 offhand
# 0-9 hotbar
# 10-35 inventory
...
## If the executing entity is a mob, its aestd.item.slot score determines in what slot the item will be loaded
# -1 mainhand
# -2 offhand
# 100-101-102-103 armor (feet to head)

## If the executing entity has the aestd.item.container tag, the item will be loaded in a container's slot at context position instead. aestd.item.slot corresponds to the item's Slot tag (eg. 4 for the middle of a dropper)
