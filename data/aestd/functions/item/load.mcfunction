...
execute if entity @s[type=minecraft:player] in minecraft:overworld run function aestd.internal:load_player_item
execute unless entity @s[type=minecraft:player] in minecraft:overworld run function aestd.internal:load_mob_item
