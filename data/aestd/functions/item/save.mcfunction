...
execute unless entity @s[type=minecraft:player] in minecraft:overworld run function aestd.internal:save_mob_item
execute in minecraft:overworld run data modify block 1519204 6 0 RecordItem.tag.aestd.SavedItem.Slot set value 0b
