...
execute at @s run data modify entity @e[type=minecraft:area_effect_cloud,tag=aestd.damage.thing_that_makes_mobs_angry,limit=1,sort=nearest] OwnerUUIDLeast set from block 1519204 6 0 RecordItem.tag.aestd.EntityUUIDLeast
execute at @s run data modify entity @e[type=minecraft:area_effect_cloud,tag=aestd.damage.thing_that_makes_mobs_angry,limit=1,sort=nearest] OwnerUUIDMost set from block 1519204 6 0 RecordItem.tag.aestd.EntityUUIDMost
