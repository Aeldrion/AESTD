...
execute as @p run function aestd1:entity/get_uuid
function aestd1:entity/anger



## aestd1:entity/damage
...
## aestd1:entity/get_distance

# This function displays to all players their distance to the nearest creeper
execute as @a at @s at @e[type=minecraft:creeper,limit=1,sort=nearest] run function aestd1:entity/get_distance
...
execute as @e[type=minecraft:arrow] run function aestd1:entity/get_motion
...
execute as @a[tag=holding_compass] run function aestd1:entity/get_position
...
## aestd1:entity/knockback

# This function simulates the hitting of the nearest cow by the nearest player (see also aestd:entity/damage)
execute as @e[type=minecraft:cow,limit=1,sort=nearest] at @p run function aestd1:entity/knockback
execute as @p run function aestd1:entity/get_uuid
...
execute as @e[type=minecraft:cow,limit=1,sort=nearest] run function aestd1:entity/damage



## aestd1:entity/offset_position
...
function aestd1:entity/offset_position
...
function aestd1:entity/teleport_to_chunk_corner
execute at @s run teleport @s ~ 0 ~
function aestd1:entity/offset_position



## aestd1:entity/set_direction
...
execute as @e[type=minecraft:fireball,limit=1,sort=nearest] run function aestd1:entity/set_direction



## aestd1:entity/set_head

# This function copies the nearest player's head to the executing entity
execute as @p run function aestd1:player/get_name
function aestd1:entity/set_head



## aestd1:entity/set_head_to_block

# This function places on every mob's head the block it is standing on
execute as @e[type=#aestd1:mobs] positioned ~ ~-1 ~ run function aestd1:block/get_block_id
execute as @e[type=#aestd1:mobs] run function aestd1:entity/set_head_to_block



## aestd1:entity/set_motion
...
function aestd1:math/random_range_lcg
...
## aestd1:entity/set_motion_from_position
...
## aestd1:entity/set_motion_from_rotation
...
## aestd1:entity/set_motion_magnitude

# This function triples the motion of all mobs
execute as @e[type=#aestd1:mobs] run function aestd1:entity/get_motion_magnitude
scoreboard players set $3 aestd.math.var 3
execute as @e[type=#aestd1:mobs] run scoreboard players operation @s aestd.math.out *= $3 aestd.math.var
execute as @e[type=#aestd1:mobs] run scoreboard players operation @s aestd.math.in = @s aestd.math.out
execute as @e[type=#aestd1:mobs] run function aestd1:entity/set_motion_magnitude
...
execute as @e[type=minecraft:creeper] run function aestd1:entity/set_motion_magnitude



## aestd1:entity/set_position

# This function teleports all arrows that hit the ground back to where they were shot
execute as @e[type=minecraft:arrow,tag=!shot] run function aestd1:entity/get_position
tag @e[type=minecraft:arrow] add shot
execute as @e[type=minecraft:arrow,tag=shot,nbt={inGround:1b},tag=!in_ground] run function aestd1:entity/set_position
tag @e[type=minecraft:arrow,tag=shot,nbt={inGround:1b}] add in_ground



## aestd1:entity/teleport_surface
...
## aestd1:entity/projectile/set_owner_uuid
...
# Set motion forward
execute anchored eyes positioned ^ ^ ^13 as @e[type=minecraft:arrow,tag=new,limit=1] run function aestd1:entity/set_motion_from_position
# Set arrow's owner UUID to the player's
function aestd1:entity/get_uuid
execute as @e[type=minecraft:arrow,tag=new,limit=1] run function aestd1:entity/projectile/set_owner_uuid
...
## aestd1:entity/wolf/tame

# This function makes all wild wolves tamed to a random player
execute as @r run function aestd1:player/get_uuid
execute as @e[type=minecraft:wolf,nbt={OwnerUUID:""}] run function aestd1:entity/wolf/tame
...
execute as @a run function aestd1:item/add_damage



## aestd1:item/add_enchantment
...
function aestd1:item/add_enchantment



## aestd1:item/add_lore
...
execute as @a run function aestd1:item/save
scoreboard players set @a aestd.item.slot 103
execute as @a run function aestd1:item/load



## aestd1:item/merge_nbt
...
## aestd1:item/remove_attribute_modifiers
...
execute if block ~ ~ ~ minecraft:dropper run function aestd1:item/remove_attribute_modifiers
tag @s remove aestd.item.container



## aestd1:item/remove_enchantments

# This function removes all enchantments on the player's helmet
scoreboard players set @s aestd.item.slot 103
scoreboard players set @s aestd.list_mode 1
function aestd1:item/remove_enchantments
...
## aestd1:item/set_block_id

# This function makes all players hold the block they're standing on in their offhand
scoreboard players set @a aestd.item.slot -2
execute as @a at @s positioned ~ ~-0.1 ~ run function aestd1:block/get_block_id
execute as @a run function aestd1:item/set_block_id
...
## aestd1:world/get_daytime

# This function gives hunger to all players during night
function aestd1:world/get_daytime
...
function aestd1:world/remove_time



## aestd1:world/set_time
