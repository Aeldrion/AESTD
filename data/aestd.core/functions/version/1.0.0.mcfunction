...
scoreboard players set #aestd.this_version aestd.version 1
scoreboard players set #aestd.this_storage_version aestd.version 1
scoreboard players set #aestd.this_scoreboard_version aestd.version 1
